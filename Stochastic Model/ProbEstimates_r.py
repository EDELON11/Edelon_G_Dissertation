...
def calculate_prob_requests(hotelData_requests, requested_room_type,
...
# probability = calculate_prob_requests(hotelData_requests,"Comfort Room","January","LS",2,True,False,2,0)
# print("Probability:", probability)
probability = calculate_prob_requests(hotelData_requests,"Luxury Suite","December","LS",3,False,True,1,0)
print("Probability:", probability)
